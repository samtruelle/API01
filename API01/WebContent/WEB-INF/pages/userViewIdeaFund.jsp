		    ...
		    <div class="row">
		        <div class="col-md-12">
		            <div class="well well-sm col-md-3">
	                	...
	                	<div id="upDownScore">
		                	<a href="userLikeIdea?id=${idea.idea_id}"
						        class="btn btn-success glyphicon glyphicon-thumbs-up"> Like</a>						    
							<a href="userDislikeIdea?id=${idea.idea_id }"
								class="btn btn-success glyphicon glyphicon-thumbs-down"> Dislike</a>						    
	                	</div>				                                
		       		</div>
